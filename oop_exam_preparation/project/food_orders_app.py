...
class FoodOrdersApp:
	...
	def register_client(self, client_phone_number: str):
		if self.__check_if_clients_exist(client_phone_number):
	...
	def __check_if_clients_exist(self, client_phone_number):
		for c in self.clients_list:
			if client_phone_number == c.phone_number:
				return True
	...
	def add_meals_to_menu(self, *meals):
		for m in meals:
			if type(m).__name__ in ["Starter", "MainDish", "Dessert"]:
				self.menu.append(m)
	...
	def show_menu(self):
		...
		meals_in_menu=[]
		for m in self.menu:
			meals_in_menu.append(m.details())
	...
	def add_meals_to_shopping_cart(self, client_phone_number: str, **meal_names_and_quantities):
		self.__check_menu()
		if not self.__check_if_clients_exist(client_phone_number):
